...
import { set_local_stream, set_remote_streams } from "../Actions/roomActions";
...
export const getLocalStreamPreview = (onlyAudio = false, callbackFunc) => {
  ...
  navigator.mediaDevices
    ...
    .then((stream) => {
      store.dispatch(set_local_stream(stream));
      callbackFunc();
    })
    .catch((err) => {
      console.log(err);
...
const addNewRemoteStream = (remoteStream) => {
  ...
  store.dispatch(set_remote_streams(newRemoteStreams));
};
